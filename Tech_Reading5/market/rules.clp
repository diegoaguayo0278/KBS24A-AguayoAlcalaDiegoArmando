;; Define a rule for finding those customers who have not bought anything at all... so far
...
;; Define a rule for texting customers who have not bought anything
(defrule text-cust
...
;; Define a rule for calling customers who have not bought anything
(defrule call-cust
    (customer (customer-id ?cid) (name ?name) (phone ?phone))
    (not (order (order-number ?order) (customer-id ?cid)))
=>
